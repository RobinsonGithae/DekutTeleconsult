...
public class StudentVideoCallActivity extends AppCompatActivity {
    private static final String TAG = StudentVideoCallActivity.class.getSimpleName();
...
//    private LoggerRecyclerView mLogView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_video_call);
        initUI();
